...
describe("AutoHotkey sample fixtures", () => {
  ...
  it("tokenizes sample.ahk", async () => {
    ...
    const text = require("fs").readFileSync(path.join(__dirname, "fixtures", "sample.ahk"), "utf8");
    ...
    // "source.ahk2" and nothing else. That is what this rules out.
    scopes.delete("source.ahk2");
